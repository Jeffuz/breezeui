            ...
            <header className='sticky top-0 z-50 w-full backdrop-blur'>
                ...
                <div className='sm:flex justify-between p-4 px-6 max-w-6xl mx-auto hidden'>
                    ...
                    <div className='flex gap-6 items-center font-normal text-gray-500'>
                        <Link href={"/docs"} className='hover:text-black transition duration-200'>Docs</Link>
                        <Link href={"/docs/components"} className='hover:text-black transition duration-200'>Components</Link>
